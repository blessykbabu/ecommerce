...
const sendEmail=require("../utils/Email-template/send-email.js").sendEmail;
const forgotPassword=require("../utils/Email-template/forgot-password.js").forgotPassword;
const { sign } = jwt;
